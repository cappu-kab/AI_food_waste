...
(function () {
  ...
  function badge(type) {
    const map = {
      ...
      "Database Reference": { cls: "badge-db", th: "ฐานข้อมูลอ้างอิง" },
  ...
  function publicNav(active) {
    const items = [
      ...
      { href: "public-dashboard.html", id: "public", label: "แดชบอร์ดสาธารณะ" },
      { href: "learning.html", id: "learning", label: "ศูนย์เรียนรู้" },
      { href: "how-it-works.html", id: "how", label: "วิธีการทำงาน" },
      { href: "formulas.html", id: "formulas", label: "คลังสูตร" },
  ...
  function privateSidebar(active) {
    ...
    const items = [
      { href: "dashboard.html", id: "dashboard", label: "แดชบอร์ดโรงเรียน", icon: "◈" },
      { href: "kitchen.html", id: "kitchen", label: "บันทึกครัว", icon: "◎" },
      { href: "analysis.html", id: "analysis", label: "วิเคราะห์ขยะอาหาร", icon: "◉" },
      { href: "route1.html", id: "route1", label: "เส้นทาง 1: ลดที่ต้นทาง", icon: "①" },
      { href: "route2.html", id: "route2", label: "เส้นทาง 2: ใช้ทางการเกษตร", icon: "②" },
      { href: "route3.html", id: "route3", label: "เส้นทาง 3: เป้าหมาย & ปรับสูตร", icon: "③" },
      { href: "reports.html", id: "reports", label: "รายงาน", icon: "▤" },
    ...
    return `
      <aside class="sidebar">
        ...
        <div class="sidebar-foot">
          <a href="index.html" class="btn btn-ghost btn-sm">ดูหน้าสาธารณะ</a>
  ...
  function lowConfidenceBanner() {
    return `<div class="banner banner-warn" role="status">
      <strong>ความมั่นใจต่ำ (LOW CONFIDENCE)</strong>
      — ค่าคุณสมวัสดุมาจาก ${badge("Database Reference")} ไม่ใช่ค่าวัดจากห้องปฏิบัติการของวันนี้
    </div>`;
  }
  ...
  function howCalculatedPanel(id, title, lines) {
    return `
      <details class="how-panel" id="${id}">
        <summary>คำนวณอย่างไร? / How was this calculated?</summary>
        <div class="how-body">
          <h4>${title}</h4>
